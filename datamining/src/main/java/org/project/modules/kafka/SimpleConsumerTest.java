...
public class SimpleConsumerTest {
    ...
    private String findNewLeader(String a_oldLeader, String a_topic,
        ...
        for (int i = 0; i < 3; i++) {
            ...
            PartitionMetadata metadata = findLeader(borkerList, a_port,
                    a_topic, a_partition);
            if (metadata == null) {
                goToSleep = true;
    ...
    public static void main(String arg[]) {
        String[] args={"20", "test", "1", "centos.master,centos.slave1,centos.slave2", "9092"};
        SimpleConsumerTest example = new SimpleConsumerTest();
        long maxReads = Long.parseLong(args[0]);
        String topic = args[1];
        int partition = Integer.parseInt(args[2]);
        List<String> seeds = new ArrayList<String>();
        seeds = Arrays.asList(args[3].split(","));
