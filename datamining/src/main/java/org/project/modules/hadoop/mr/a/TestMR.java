...
class TestMapper extends Mapper<LongWritable, Text, Text, Text> {
	...
	protected void map(LongWritable key, Text value, Context context)
		...
		context.write(new Text("user"), new Text("url1"));
		context.write(new Text("user"), new Text("url2"));
		context.write(new Text("user"), new Text("url3"));
		context.write(new Text("user"), new Text("url4"));
		context.write(new Text("user"), new Text("url5"));
	}
}
